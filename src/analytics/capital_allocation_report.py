...
def update_cashflow_intelligence(
    ...
    logger.info(
        "Updating Cashflow Intelligence..."
    )
...
def print_summary(
    ...
    print(
        f"Expected Companies : {verification['expected_companies']}"
    )

    print(
        f"Companies Found    : {verification['found_companies']}"
    )

    print(
        f"Missing Companies  : {verification['missing_companies']}"
    )

    print(
        f"Minimum Years      : {verification['minimum_years']}"
    )

    print(
        f"Maximum Years      : {verification['maximum_years']}"
    )

    print(
        f"Average Years      : {verification['average_years']}"
    )

    low_history = verification.get("low_history", [])

    print(
        f"Companies <5 Years : {len(low_history)}"
    )
    ...
    print(
        f"Pattern Categories : {len(distribution_df)}"
    )

    print(
        f"Pattern Changes    : {len(pattern_changes_df)}"
    )
...
def main():
    ...
    try:
        ...
        logger.info(
            "Sprint 5 Day 32 Completed Successfully."
        )
