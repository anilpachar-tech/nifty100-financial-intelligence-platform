...
class TestLeverageRatios(unittest.TestCase):
    ...
    def test_debt_to_equity_normal(self):
        self.assertEqual(debt_to_equity(500, 200, 300), 1.0)

    # Test 2
    def test_debt_to_equity_debt_free(self):
        self.assertEqual(debt_to_equity(0, 200, 300), 0.0)
    ...
    def test_high_leverage_flag(self):
        self.assertTrue(high_leverage_flag(6.0, "Industrials"))

    # Test 7
    def test_net_debt(self):
        self.assertEqual(net_debt(500, 100), 400)
